...
const Education = () => {
  return (
    <div className='border border-gray-500 bg-[#191919] h-[45.9rem]  p-4   rounded-md'>
    ...
    <div className="flex justify-between mt-10 mb-5 items-center">
      ...
      <ul >
        <li className='text-red-100'>Creating full-Scale responsive Web Applications</li>
  ...
  <p className='text-xl fontfont-semibold'>Diploma in ME Engg</p>
